...
import {
  ...
  TabsList,
  TabsTrigger,
} from "@/components/desktop/ui/tabs";
...
import { Checkbox } from "@/components/desktop/ui/checkbox";
import { Label } from "@/components/desktop/ui/label";
import {
  Alert,
  AlertDescription,
  AlertTitle,
} from "@/components/desktop/ui/alert";
          ...
          <div className="flex items-center gap-3 p-3 bg-zinc-900 rounded-xl border border-zinc-800 mb-4">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="h-8 w-8"
                onClick={() =>
                  setPortfolioCount(Math.max(0, portfolioCount - 1))
                }
              ...
              <Button
                ...
                onClick={() =>
                  setPortfolioCount(
                    Math.min(allProjects.length, portfolioCount + 1),
                  )
                }
      ...
      <Dialog open={countDialogOpen} onOpenChange={setCountDialogOpen}>
        <DialogContent className="max-w-lg">
          ...
          <p className="text-sm text-zinc-400 mb-3">
            Choose exactly {portfolioCount} project(s) to show on your
            portfolio. Currently {selectedProjectIds.size} selected.
          </p>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                countSaving || selectedProjectIds.size !== portfolioCount
              }
            >
              {countSaving ? (
                <div className="flex items-center gap-2">
