...
import { FlightButton } from "@/components/mobile/FlightButton";
import DisplacementText from "@/components/mobile/DisplacementText";
import { ArrowLeft } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import SocialHoverCard from "@/components/mobile/pixel-perfect/social-hover-card";
          ...
          <div className="flex-shrink-0">
            ...
            <div className="flex flex-wrap gap-1.5">
              <SocialHoverCard socialName="GitHub">
                <a href="https://github.com/Mubassim-Khan?tab=overview&from=2026-05-01&to=2026-06-30" target="_blank" className="flex items-center gap-1.5 px-2.5 py-1.5 bg-zinc-100 dark:bg-zinc-800/40 hover:bg-zinc-200 dark:hover:bg-zinc-800 rounded-md text-[12px] font-medium text-zinc-600 dark:text-zinc-300 transition-colors border border-zinc-200/50 dark:border-zinc-700/50">
              ...
              <SocialHoverCard socialName="LinkedIn">
                <a href="https://www.linkedin.com/in/mubassim/" target="_blank" className="flex items-center gap-1.5 px-2.5 py-1.5 bg-zinc-100 dark:bg-zinc-800/40 hover:bg-zinc-200 dark:hover:bg-zinc-800 rounded-md text-[12px] font-medium text-zinc-600 dark:text-zinc-300 transition-colors border border-zinc-200/50 dark:border-zinc-700/50">
                  <svg viewBox="0 0 24 24" className="w-3.5 h-3.5">
