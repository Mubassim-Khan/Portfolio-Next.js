...
import { ProjectsGrid } from "@/components/mobile/ProjectsGrid";
import { ExperienceList } from "@/components/mobile/ExperienceList";
import { OpenSourceContributions } from "@/components/mobile/OpenSourceContributions";
...
import { GithubGraph } from "@/components/mobile/GithubGraph";
...
const socials = [
  ...
  },
  {
    ...
    icon: <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2zM4 2a2 2 0 1 1-2 2 2 2 0 0 1 2-2z" stroke="currentColor" strokeWidth="2" fill="none" />,
  },
  {
    name: "Discord",
    ...
    <div className="min-h-screen w-full bg-white dark:bg-black relative overflow-x-hidden transition-colors duration-300">
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <div className="flex flex-col justify-center pt-8">
              ...
              <p className="text-[13px] sm:text-[14px] text-zinc-500 dark:text-zinc-400">Software Developer</p>
            </div>
          </div>
      ...
      <div className="ml-0 mr-0 md:ml-[30%] md:mr-[30%] pt-[calc(22vh+112px)] pb-0 px-4 flex flex-col z-10 relative min-h-screen">
        <p className="text-[14px] sm:text-[15px] text-zinc-600 dark:text-zinc-300 leading-relaxed mt-4">
          My name is Mubassim Ahmed Khan, and I am Software Engineer at ChaseValue, Head Office.
        </p>
