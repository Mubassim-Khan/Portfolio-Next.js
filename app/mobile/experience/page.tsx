                ...
                <div key={idx} className="group relative">
                  ...
                  >
                    <div className="flex min-w-0 flex-1 items-start gap-3 sm:gap-4">
                      <div className="size-10 shrink-0 rounded-[10px] border border-black/10 bg-zinc-50 dark:border-zinc-800 dark:bg-[#111111] p-[2px] shadow-sm shadow-black/15 dark:shadow-md dark:shadow-black/50 flex items-center justify-center overflow-hidden">
                        {item.logo ? (
                          <Image
                            src={item.logo}
